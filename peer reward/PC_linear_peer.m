...
syms r c alpha beta
bij(1,1)=r*c/(k+1);bij(1,2)=0;bij(1,3)=r*c/(k+1)+beta/k;ci(1)=r*c/(k+1)-c;
bij(2,1)=r*c/(k+1);bij(2,2)=0;bij(2,3)=r*c/(k+1);ci(2)=0;
bij(3,1)=r*c/(k+1)-alpha/k;bij(3,2)=0;bij(3,3)=r*c/(k+1)+(beta-alpha)/k;ci(3)=r*c/(k+1)-c;

k_value=4;
r_value=3;c_value=1;
alpha_value=0.7;beta_value=5;
